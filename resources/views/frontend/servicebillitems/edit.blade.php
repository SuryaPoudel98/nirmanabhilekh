...
<div id="ContainerTopRight" style="margin-top:110px; display:none;" class="toasts-top-right ">
  <div class="alert alert-success alert-dismissible fade show" role="alert" aria-live="assertive" aria-atomic="true">
    <div class="header"><strong class="mr-auto">&nbsp;&nbsp;&nbsp;&nbsp;Service Billing</strong>
...
<div class="col-md-12">
  ...
  <div class="card card-info">
    <div class="card-header">
      <h3 class="card-title">Update Service Bill </h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    @if($errors->any())
    ...
    <form action="" method="POST">
      ...
      <div class="card-body">
        ...
        <div style="border-bottom:red" class="form-group row">
          <div class="col-sm-2">
            <label for="status" class=" col-form-label">Date</label>
            <input type="date" id="billDate" class="form-control" name="billDate" value="{{@$data[0]->billDate}}" />
          </div>


          <div class="col-sm-1">
            <label for="status" class=" col-form-label">Bill No</label>
            <input type="hidden" value="{{@$data[0]->tCode}}" id="tCode" name="tCode">
            <input type="text" class="form-control" value="{{@$data[0]->id}}" readonly id="billNo" name="billNo" />
          </div>

          <div class="col-sm-3">
            <label for="status" class=" col-form-label"> Customer:*</label>
          ...
          <div class="col-sm-3">
            <label for="status" class=" col-form-label">Contact:*</label> <input type="text" autocomplete="off" class="form-control" value="{{$data[0]->customer_phonenumber}}" id="customerContact" placeholder="Customer Contact Number">
          </div>
        </div>
      ...
      <div class="card-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-3">
            <label for="status" class=" col-form-label">Total:</label>
          ...
          <div class="col-sm-3">
            <label for="status" class=" col-form-label">All Total:</label>
    ...
    <div class="card-footer">
      <input type="button" value="Save" onclick="saveDataIntoTable()" class="btn btn-info"></button>
...
<script type="text/javascript">
  ...
  function saveDataIntoTable() {
    if (document.getElementById("customer_id").value == '') {
      ...
      axajUrl = "/update/servicebillitems";
      $.ajax({
        type: "POST",
        url: axajUrl,
        data: {
