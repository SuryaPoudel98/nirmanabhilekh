...
<section class="content-header">
      ...
      <div class="col-md-12">
        <div class="card card-info">
          <div class="card-header">
            <h3 class="card-title"> Project progress list</h3>
              ...
              <table class="table table-hover text-nowrap">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $projectactivity->budget }} </td>
                    <td>
                      <a style="width:40px" href="{{url('projectprogress-edit/' . $projectactivity->tCode)}}" class="btn btn-info btn-sm"><i class="fas fa-edit"></i></a>
  ...
  <script>
    function showModal(id) {
      document.getElementById("deleteItem").href = "/projectprogress-delete/" + id;
