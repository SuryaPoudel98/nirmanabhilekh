<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="http://tukisoft.com.np/" target="_blank" class="brand-link">
    <img src="/image/nirmal-abhilekh.png" alt="Tuki Soft Thekedar" class="brand-image  elevation-3" style="opacity: .8">
  ...
  <div class="sidebar os-host os-theme-light os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition">
    ...
    <div class="os-content-glue" style="margin: 0px -8px; width: 249px; height: 794px;"></div>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="/incomeequipment/add" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Equipment</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/servicebillitems/add" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Service</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="/expensesequipment/add" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Equipment</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/expensesstaff/add" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Staff</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="/projectactivities/add" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p> Summary</p>
                    </a>
                  </li>
              ...
              <li class="nav-header">RECORD KEEPING</li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview" style="display: none;">
                  ...
                  <li class="nav-item">
                    <a href="/service/add" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Service</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/suppliers/add" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Suppliers</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="/activities/add" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Project Items</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/projectleader/add" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Project Leader</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="/servicecatagory/add" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Service</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/activitiescatagory/add" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Activities</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/equipmentcatagory/add" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>
                        Equipment
                        <!-- <i class="fas fa-angle-left right"></i> -->
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview" style="display: none;">
                  <li class="nav-item">
                    <a href="/customerwise" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Service </p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="/expensesreport" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Equipment</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/staffexpensesreport" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Staff</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="/projectactivitiesreport" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Summary</p>
                    </a>
                  </li>
                  ...
                  <li class="nav-item">
                    <a href="/projectwise" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Title Wise</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/supplierswise" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Party Wise</p>
                    </a>
                  </li>
    ...
    <div class="os-scrollbar os-scrollbar-vertical os-scrollbar-auto-hidden">
      <div class="os-scrollbar-track">
        <div class="os-scrollbar-handle" style="height: 72.2727%; transform: translate(0px, 0px);"></div>
      </div>
    </div>
