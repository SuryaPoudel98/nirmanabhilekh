...
<div class="col-md-12">
  ...
  <div class="card card-info">
    <div class="card-header">
      <h3 class="card-title">Edit Project Estimation </h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    @if($errors->any())
        ...
        <div class="form-group ">
          <div class="row">
            <div class="col-sm-6">
              ...
              <input type="hidden" id="billDate" value="{{@$data[0]->fiscal_year}}" class="form-control" name="billDate" />
            ...
            <div class="col-sm-4">
              ...
              <div class="input-group ">
                <input type="text" readonly autocomplete="off" class="form-control" id="projectlocation" value="{{@$data[0]->project_address }}" placeholder="Enter project location">
...
<script type="text/javascript">
  ...
  function saveDataIntoTable() {
...

    {
      ...
      axajUrl = "/update/projectestimation";
      $.ajax({
        type: "POST",
        url: axajUrl,
        data: {
