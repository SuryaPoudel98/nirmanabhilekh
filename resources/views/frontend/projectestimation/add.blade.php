...
<div id="ContainerTopRight" style="margin-top:110px; display:none;" class="toasts-top-right ">
    <div class="alert alert-success alert-dismissible fade show" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="header"><strong class="mr-auto">&nbsp;&nbsp;&nbsp;&nbsp;Message</strong>
...
<div class="col-md-12">
    ...
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title">Add Project Estimation </h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        @if($errors->any())
        ...
        <form action="{{route('postProjectActivitiesData')}}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="hidden" id="billDate" class="form-control" name="billDate" />
                    ...
                    <div>
                        ...
                        <input type="hidden" autocomplete="off" class="form-control" name="supplierssearchKey" onkeyup="searchSuppliers();" id="supplierssearchKey" placeholder="Search Suppliers Name">
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="number" class="form-control" name="debit" id="debit" onkeyup="changeDebitCredit('debit');" placeholder="Enter Qty">
                    </div>
...
<script type="text/javascript">
    ...
    function saveDataIntoTable() {
...

        {
            ...
            axajUrl = "/post/projectestimation";
            $.ajax({
                type: "POST",
                url: axajUrl,
                data: {
                ...
                success: function(dataResult) {
                    ...
                    window.location.href = "/projectestimation/list";
                }
            });
    ...
    function checkthisprojecthasestimationrecordornot(project_id) {
        var data;
        axajUrl = "/checkthisprojecthasestimationrecordornot/" + project_id;
        $.ajax({
            type: "GET",
            url: axajUrl,
            async: false,
    ...
    function putItemIntoTextField(id, projectName, projectlocation) {
        if (checkthisprojecthasestimationrecordornot(id) != null) {
            alert("This project has already estimated, please edit.")
            return;
        }
