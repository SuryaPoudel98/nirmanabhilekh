...
Route::post('/update/projectprogress', [ProjectEstimationController::class, 'updateProjectProgressData'])->name('updateProjectProgressData');
...
Route::get('/projectprogress/{id}/{projectname}', [ProjectEstimationController::class, 'projectprogress']);
...
Route::get('/projectestimationreport/{project_id}', [ProjectEstimationController::class, 'estimationReport'])->name('estimationReport');

Route::post('projectestimationreportfilter', [ProjectEstimationController::class, 'projectestimationreportfilter'])->name('projectestimationreportfilter');
...
Route::get('projectprogress-delete/{projectestimation_id}', [ProjectEstimationController::class, 'deleteprojectprogress'])->name('deleteprojectprogress');
...
Route::get('projectprogress-edit/{tcode}', [ProjectEstimationController::class, 'editprojectprogress'])->name('editprojectprogress');
...
Route::get('/checkthisprojecthasestimationrecordornot/{searchKey}', [ProjectEstimationController::class, 'checkthisprojecthasestimationrecordornot']);
